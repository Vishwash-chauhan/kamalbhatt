...
export default function TrainingInstructorSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
              <span className="font-bold text-primary">Kamal Bhatt</span> - Founder & CEO of <span className="font-bold text-primary">Meegan Media</span>. I've had the privilege of helping 100+ businesses across India achieve exponential growth through strategic SEO, Google Ads, and social media marketing.
            </p>
